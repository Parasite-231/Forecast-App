...
if (isset($_POST['search'])) {
    ...
    require("../Controllers/sensorAlarmMessageBetweenTwoDate.php");
          ...
          <li class="nav-item">
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                <div
                    ...
                    <h1 class="heading" style="font-size: 17px;"> <i class='bx bxs-notepad'></i></i>&nbsp;AlARM DATA
                        AND ALARM MESSAGE BETWEEN TWO DATE </h1>
