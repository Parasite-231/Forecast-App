...
if (isset($_POST['search'])) {
    ...
    require("../../Controllers/alarm based/alarmMessageBasedOnSpecificSensorAndLocation.php");
    ...
    $query =  findAlarmMessageBasedOnSpecificSensorAndLocationBetweenOnTwoDates($sensor_id,$loc,$start_date,$end_date);
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                <div
                    ...
                    <h1 class="heading" style="font-size: 17px;"> <i class='bx bxs-notepad'></i></i>&nbsp;ALARM MESSAGE
                        BASED ON SPECIFIC SENSOR AND LOCATION BETWEEN TWO DATE </h1>
...
if ($result && mysqli_num_rows($result) > 0) {
    ...
    echo " <a href='showAlarmMessageBasedOnSpecificSensorAndLocation.php' style='float:right;margin:1%' class='btn btn-danger'>Reset</a>";
}
...
<a href='showAlarmMessageBasedOnSpecificSensorAndLocation.php' style='float:right;margin:1%' class='btn btn-danger'>Search Again</a>
";
  } 
