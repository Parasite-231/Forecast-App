<?php
                    ...
                    $query = "SELECT LOCATION_NAME AS LOCATION_NAME, LONGITUDE AS LONGITUDE, LATITUDE AS LATITUDE FROM LOCATION
                    WHERE DELETE_FLAG = 0";
...
?>
   ...
   if ($result && mysqli_num_rows($result) > 0) {
    // echo mysqli_num_rows($result); //10
  ...
  <div class='card'>
    ...
    <div class='card-body'>
      <h5 class='card-title' style='text-align:center'> $location_name</h5>
                <iframe width='100%' height='500' src='https://maps.google.com/maps?q=$latitude,
                    $longitude 
                &output=embed'></iframe>
