...
<body>
                    ...
                    <div class=" card-body">
                        <form method="POST">
                            <div class="mb-3 row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control-plaintext" name="latitude" id="staticEmail"
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control-plaintext" name="longitude" id="staticEmail"
                                        placeholder="Enter Longitude">
                                </div>
                            </div>

                            <input type="submit" value="Show Location" style="background-color: #89CFF0;"
                                name="submit_coordinates">
                        </form>
                    </div>
                </div>
                <?php
    if (isset($_POST["submit_coordinates"]))
    {
        ...
        ?>
                ...
                <iframe width="100%" height="500" src="https://maps.google.com/maps?q=<?php echo $latitude; ?>,<?php echo $longitude; ?>
    &output=embed"></iframe>
