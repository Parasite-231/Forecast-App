...
<body>
    ...
    <div class="vertical-menu">
        <ul class="nav flex-column">
            ...
            <li class="nav-item">
                <a href="../Admin Panel/alarm information/showAlarms.php" class="nav-link " style="color: white;">
                    <i class='bx bxs-alarm-exclamation'></i>
                    Alarm Categories
                </a>
            </li>
            <li class="nav-item">
                <a href="../Admin Panel/alarm information/showActiveAlarms.php" class="nav-link " style="color: white;">
