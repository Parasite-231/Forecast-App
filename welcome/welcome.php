...
<head>
    ...
    <link rel="shortcut icon" type="image/x-icon" href="./icons/weather-modified.png">
    <link rel="stylesheet" href="https://stackpath.bootstrapcdn.com/font-awesome/4.7.0/css/font-awesome.min.css">
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.1.3/dist/css/bootstrap.min.css" rel="stylesheet"
        integrity="sha384-1BmE4kWBq78iYhFldvKuhfTAU6auU8tT94WrHftjDbrCEXSU1oBoqyl2QvZ6jIW3" crossorigin="anonymous">
    <link rel="stylesheet" href="./css files/chooseUserDesign.css">
...
<body>
    <header>
        ...
        <div class="platform-selection">
            ...
            <div class="contain">
                <a href="#"><button type="button" class="btn btn-dark btn-lg">User Platform</button></a>
                <a href="../Admin Panel/dashboard.php"><button type="button" class="btn btn-dark btn-lg">Admin
                        Platform</button></a>
            </div>
        </div>
        <!--Changed 2.0-->
