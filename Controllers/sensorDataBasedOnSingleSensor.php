...
function findSensorDataBasedOnSingleSensorBetweenTwoDates($sensor_id,$start_date,$end_date){
...
FROM SENSOR_DATA 
INNER JOIN sensor_location_information 
...
WHERE sensor_location_information.SENSOR_ID = '$sensor_id' AND SENSOR_DATA.DATE BETWEEN '$start_date' AND '$end_date' 
ORDER BY SENSOR_DATA.DATE DESC, SENSOR.SENSOR_TYPE ";
