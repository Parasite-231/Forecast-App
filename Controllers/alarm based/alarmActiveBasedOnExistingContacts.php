...
function findAlarmActiveBasedOnExistingContacts(){



  $query = "SELECT ALARM_CATEGORY.ALARM_ID AS ALARM_CATEGORY_ID,
  ...
  CONTACT_INFORMATION.PHONE_NUMBER AS CONTACT_NUMBER
  FROM ALARM_CATEGORY 
  ...
  INNER JOIN CONTACT_INFORMATION ON
  LOCATION.LOCATION_ID = CONTACT_INFORMATION.LOCATION_ID
  INNER JOIN SENSOR ON
  SENSOR_LOCATION_INFORMATION.SENSOR_ID = SENSOR.SENSOR_ID
  WHERE ALARM_CATEGORY.DELETE_FLAG = 0 ORDER BY ALARM_INFORMATION.RECORDED_DATE DESC ";
