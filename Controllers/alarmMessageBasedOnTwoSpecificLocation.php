...
function findAlarmMessageBasedOnTwoSpecificLocationBetweenOnTwoDates($loc_first,$loc_second,$start_date,$end_date){
  ...
  LOCATION.LOCATION_ID IN($loc_first,$loc_second)  AND
